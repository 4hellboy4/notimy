      ...
      body: Center(
          child: StreamBuilder<DocumentSnapshot<Map<String?, dynamic>>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData &&
                    snapshot.data?['usersNotimy'].length != 0) {
                  var userItems = snapshot.data?.data();
                  return Consumer<ListNotimies>(
                      builder: (context, listdo, child) {
                                                  ...
                                                  Row(children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Text(
                                                          '',
                                                          //userItems?['usersNotimy'][listdo.notimiesList[index].userName]??["status"],
                                                          style: sizeTextWhite(),
                                                        ),
                                                      ),
                                                    ),
